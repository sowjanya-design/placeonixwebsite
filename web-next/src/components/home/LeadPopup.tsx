...
export default function LeadPopup() {
  ...
  return (
    <>
      ...
      <form className="lead-popup show" role="dialog" aria-modal="true" aria-labelledby="leadPopupTitle" ref={formRef} onSubmit={onSubmit}>
        ...
        {submitted ? (
          <p className="lead-popup-sub">Thanks! Our Career Guidance Team will reach out shortly.</p>
        ) : (
          <>
            <p className="lead-popup-sub">Unlock your potential — talk to our Career Guidance Team about the right SAP or IT programme for you.</p>
            <div className="f-group"><label>Full Name</label><input name="fullName" type="text" required placeholder="Your name" /></div>
            <div className="f-group"><label>Email</label><input name="email" type="email" required placeholder="you@example.com" /></div>
            <div className="f-group"><label>Mobile Number</label><input name="phone" type="tel" required placeholder="+91 9876543210" /></div>
            ...
            <label className="lead-popup-agree">
              ...
              <span>I agree to the <a href="/terms" target="_blank" rel="noopener">Terms</a> &amp; <a href="/privacy-policy" target="_blank" rel="noopener">Privacy Policy</a> of Placeonix.</span>
            </label>
            <button type="submit" className="f-btn" disabled={submitting}>{submitting ? 'Submitting…' : 'Submit →'}</button>
          </>
        )}
      </form>
    </>
