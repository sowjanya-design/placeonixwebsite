...
const FACT_ICON: Record<string, React.ReactNode> = {
  ...
  Level: (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M4 20V12M11 20V6M18 20v-4" />
    </svg>
  ),
  Prerequisite: (
    <svg
...
export default async function CoursePage({ params }: Props) {
  const { category, slug } = await params;
  const course = resolveCourse(category, slug);
  const siblings = getCoursesByCategory(course.category)
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "Home",
            item: "https://www.placeonix.com/",
          },
          {
            "@type": "ListItem",
            position: 2,
            name: course.breadcrumbCategoryName,
            item: `https://www.placeonix.com/courses/${course.category}`,
          },
          {
            "@type": "ListItem",
            position: 3,
            name: course.h1,
            item: `https://www.placeonix.com/courses/${course.category}/${course.slug}`,
          },
        ],
      },
      {
  ...
  return (
    <>
        ...
        {course.intro.paragraphs.length > 0 && (
          <section className="section">
            <div className="inner">
              ...
              <div className="intro-body prose">
                {course.intro.video &&
          ...
          <section className="section bg-soft">
            <div className="inner">
              <div className="sec-hdr">
                ...
                {course.demand.desc && (
                  <p className="sec-desc">{course.demand.desc}</p>
                )}
              </div>
        ...
        {course.careers && (
          <section className="section" id="careers">
            <div className="inner">
                ...
                <table className="tbl">
                  <thead>
                    <tr>
                      <th>Role</th>
                      <th>Experience</th>
                      <th>Indicative Salary (India, per year)*</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <p
                className="sec-desc"
                style={{ marginTop: ".8rem", fontSize: ".82rem" }}
              >
                {course.careers.footnote}
              </p>
            </div>
          </section>
        )}
        ...
        <section className="section bg-soft" id="curriculum">
          <div className="inner">
            ...
            <CurriculumAccordion
              ...
              groupName={`curriculum-${course.slug}`}
            />
          </div>
        </section>
        ...
        <section className="section bg-soft">
          ...
          >
            <div className="prose">
              ...
              <ul>
                {course.projects.items.map((item, i) => (
            ...
            <div className="prose">
              ...
              <ul>
                {course.eligibility.items.map((item, i) => (
                  <li key={i} dangerouslySetInnerHTML={{ __html: item }} />
                ))}
              </ul>
            </div>
            ...
            <div className="inner">
              <div className="sec-hdr">
                <span className="eyebrow">
                  Explore More {categoryLabels[course.category]}
                </span>
                <h2>
                  Related {categoryLabels[course.category].toLowerCase()} &amp;
                  resources
                </h2>
              </div>
              <div className="grid grid-4">
                {siblings.map((s) => (
                  <Link
                    className="card"
                    href={`/courses/${s.category}/${s.slug}`}
                    key={s.slug}
                  >
        ...
        <section className="section" id="enquire">
          <div className="inner grid grid-2" style={{ gap: "1.2rem" }}>
            <div className="card">
              ...
              <h3>
                {course.enquire.heading ||
                  `Start your ${course.h1.replace(" Training", "")} journey`}
              </h3>
              <p>
                Contact our admissions team for the syllabus, next batch dates
                and a free counselling session.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                {course.enquire.whatsappHref && (
                  <a
                    href={course.enquire.whatsappHref}
      ...
      <div className="sticky-cta">
        ...
        <Link href="/?intent=demo#contact" className="btn btn-primary">
          Book Free Demo
        </Link>
      </div>
    </>
