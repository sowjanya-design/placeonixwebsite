...
export const metadata: Metadata = {
  title:
    "All Courses in Hyderabad | SAP, Technology & Combo Programs – Placeonix",
  description:
    "Browse all 21 training programs at Placeonix, Hyderabad — 10 SAP courses, 6 technology courses (Data Science, Cloud, Full Stack, Java, Cybersecurity, UI/UX) and 5 bundled combo packages. Instructor-led with placement assistance.",
          ...
          <div className="inner">
            ...
            <div style={{ maxWidth: 720 }}>
              ...
              <p className="lead">
                ...
                and see the full curriculum. 21 instructor-led programs with
                real hands-on projects and placement assistance.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="inner">
            <div className="sec-hdr">
              ...
              <p className="sec-desc">
                10 programs — cloud, functional and core modules for every SAP
                career path.
              </p>
            </div>
        ...
        <section className="section bg-soft" id="technology-courses">
          <div className="inner">
            <div className="sec-hdr">
              ...
              <p className="sec-desc">
                6 programs — Data Science, Cloud/DevOps, Full Stack, Java
                Backend, Cybersecurity and UI/UX Design.
              </p>
            </div>
            <div className="prog-grid">
              {technology.map((course) => (
                <ProgramCard course={course} key={course.slug} />
              ))}
            </div>
          </div>
        ...
        <section className="section" id="combo-programs">
          <div className="inner">
            <div className="sec-hdr">
              ...
              <p className="sec-desc">
                5 bundled packages — save more, learn more.
              </p>
            </div>
            <div className="prog-grid">
              {combo.map((course) => (
